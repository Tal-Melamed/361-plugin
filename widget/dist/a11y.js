(function(){"use strict";const p={fontSize:0,highContrast:!1,grayscale:!1,highlightLinks:!1,bigCursor:!1},g="bugbox_a11y",y=["100%","120%","145%"];class L{constructor(){this.listeners=new Set,this.state=this.load()}load(){try{const t=localStorage.getItem(g);return t?{...p,...JSON.parse(t)}:{...p}}catch(t){return{...p}}}persist(){try{localStorage.setItem(g,JSON.stringify(this.state))}catch(t){}}get(){return this.state}update(t){this.state={...this.state,...t},this.persist(),this.emit()}reset(){this.state={...p};try{localStorage.removeItem(g)}catch(t){}this.emit()}subscribe(t){return this.listeners.add(t),()=>this.listeners.delete(t)}emit(){for(const t of this.listeners)t(this.state)}}const E="https://nblbeaawytyuxgfoixlj.supabase.co",b="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5ibGJlYWF3eXR5dXhnZm9peGxqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODM0NDQ1NTcsImV4cCI6MjA5OTAyMDU1N30.ZHVeYpEBf2tUpS1iz30YXjVierROAgqrHJG5zHSmyJo";function A(e){var a;const t=(a=e==null?void 0:e.dataset)!=null?a:{};return{protectMedia:t.protectMedia!=="0",disableTextSelection:t.noTextSelect==="1",removeTapHighlight:t.tapHighlight!=="0",disableLinkLongPress:t.noLinkPreview!=="0",preventCopy:t.noCopy==="1",preventPrint:t.noPrint==="1"}}function T(e){var t;return(t=e==null?void 0:e.dataset.siteKey)!=null?t:""}function I(e){var a;const t=(a=e==null?void 0:e.dataset)!=null?a:{};return{accent:t.accent||"#000000",position:t.position==="bottom-right"?"bottom-right":"bottom-left"}}async function z(e,t){var a,o,i,n,l;if(!e)return null;try{const d=await fetch(`${E}/rest/v1/rpc/get_widget_config`,{method:"POST",headers:{apikey:b,authorization:`Bearer ${b}`,"content-type":"application/json"},body:JSON.stringify({p_site_key:e})});if(!d.ok)return null;const s=await d.json();return s?{protection:{...t,...(a=s.protection)!=null?a:{}},appearance:{accent:s.accent||"#000000",position:s.position==="bottom-right"?"bottom-right":"bottom-left"},statement:{url:(o=s.statement_url)!=null?o:null,coordinatorName:(i=s.coordinator_name)!=null?i:null,coordinatorPhone:(n=s.coordinator_phone)!=null?n:null,coordinatorEmail:(l=s.coordinator_email)!=null?l:null}}:null}catch(d){return null}}function m(e){var a;const t=document.documentElement;t.style.setProperty("--a11y-font-scale",(a=y[e.fontSize])!=null?a:y[0]),t.classList.toggle("a11y-high-contrast",e.highContrast),t.classList.toggle("a11y-grayscale",e.grayscale),t.classList.toggle("a11y-highlight-links",e.highlightLinks),t.classList.toggle("a11y-big-cursor",e.bigCursor)}let c=null,x=!1;function w(e){c=e;const t=document.documentElement;if(t.classList.toggle("a11y-protect-media",e.protectMedia),t.classList.toggle("a11y-no-select",e.disableTextSelection),t.classList.toggle("a11y-no-tap-highlight",e.removeTapHighlight),t.classList.toggle("a11y-no-link-preview",e.disableLinkLongPress),t.classList.toggle("a11y-no-print",e.preventPrint),!x){x=!0;const a=o=>o instanceof Element&&/^(IMG|VIDEO|PICTURE|SOURCE)$/.test(o.tagName)&&!o.closest("#a11y-widget-root");document.addEventListener("dragstart",o=>{c!=null&&c.protectMedia&&a(o.target)&&o.preventDefault()}),document.addEventListener("contextmenu",o=>{c!=null&&c.protectMedia&&a(o.target)&&o.preventDefault()},{capture:!0}),document.addEventListener("copy",o=>{if(!(c!=null&&c.preventCopy))return;const i=document.activeElement;i&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.isContentEditable||i.closest("#a11y-widget-root"))||o.preventDefault()})}}function v(e,t){e.style.setProperty("--a11y-accent",t.accent||"#000000"),e.classList.toggle("a11y-pos-right",t.position==="bottom-right")}function N(){return`
...
`}const r={triggerLabel:"פתח תפריט נגישות",panelTitle:"נגישות",close:"סגירה",reset:"איפוס הגדרות",fontSizeGroup:"גודל גופן",highContrast:"ניגודיות גבוהה",grayscale:"גווני אפור",highlightLinks:"הדגשת קישורים",bigCursor:"סמן גדול",statementTitle:"הצהרת נגישות",statementLink:"צפייה בהצהרת הנגישות",coordinator:"רכז/ת נגישות",on:"מופעל",off:"כבוי",resetDone:"כל ההגדרות אופסו"},C='<svg viewBox="0 0 71 82" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M34.8455 53.52L25.8955 78.25C25.6755 78.8697 25.3339 79.4392 24.8909 79.9252C24.4479 80.4111 23.9123 80.8038 23.3155 81.08C22.4191 81.5003 21.4181 81.645 20.4393 81.4958C19.4606 81.3466 18.5482 80.9101 17.8178 80.2418C17.0873 79.5735 16.5717 78.7033 16.3363 77.7417C16.1009 76.78 16.1563 75.7701 16.4955 74.84L22.7355 57.56C23.2307 56.2597 23.6219 54.9222 23.9055 53.56C24.1577 52.1769 24.3379 50.7817 24.4455 49.38C24.6855 46.85 24.8555 44.11 24.9855 41.48C25.1155 38.85 25.2055 36.3 25.2755 34.19C25.3655 31.56 24.6555 31.39 22.5455 30.89L22.1055 30.79L4.10551 27.4C3.45813 27.2858 2.83963 27.0451 2.28539 26.6916C1.73114 26.3381 1.25205 25.8788 0.875506 25.34C0.316124 24.5237 0.0115401 23.5598 0.000321458 22.5703C-0.0108972 21.5808 0.271754 20.6102 0.812486 19.7814C1.35322 18.9527 2.12771 18.303 3.0379 17.9147C3.94809 17.5263 4.95304 17.4168 5.92551 17.6L25.2655 21.23C26.0355 21.3 26.7855 21.39 27.5755 21.48C29.9555 21.8061 32.3535 21.9831 34.7555 22.01C37.7456 21.9516 40.7301 21.7279 43.6955 21.34C44.5955 21.24 45.4455 21.13 46.2955 21.05L64.5455 17.63C65.8402 17.3615 67.1886 17.6168 68.2955 18.34C68.8441 18.7112 69.3135 19.1878 69.6764 19.7419C70.0393 20.2961 70.2885 20.9169 70.4094 21.5681C70.5304 22.2194 70.5207 22.8882 70.381 23.5357C70.2413 24.1833 69.9743 24.7966 69.5955 25.34C69.2241 25.8823 68.7494 26.346 68.1986 26.7046C67.6478 27.0632 67.0317 27.3097 66.3855 27.43L48.9455 30.71C48.3655 30.84 47.8455 30.93 47.3855 31C45.5655 31.31 44.6655 31.47 44.7755 34.06C44.8555 35.95 45.0855 38.21 45.3855 40.57C45.7355 43.34 46.1955 46.28 46.6755 48.97C46.9855 50.74 47.2755 52.16 47.6755 53.52C48.0755 54.88 48.4655 56.27 49.0655 57.94L55.1755 74.84C55.5147 75.7701 55.5701 76.78 55.3347 77.7417C55.0993 78.7033 54.5837 79.5735 53.8532 80.2418C53.1228 80.9101 52.2104 81.3466 51.2317 81.4958C50.2529 81.645 49.2519 81.5003 48.3555 81.08C47.7587 80.8038 47.2231 80.4111 46.7801 79.9252C46.3371 79.4392 45.9955 78.8697 45.7755 78.25L36.7955 53.57L35.7955 51.74L34.7955 53.52H34.8455ZM35.2355 4.70729e-06C37.2785 -0.00173208 39.2588 0.704987 40.8391 1.99973C42.4194 3.29448 43.5018 5.09714 43.902 7.10053C44.3021 9.10392 43.9952 11.1841 43.0335 12.9865C42.0718 14.789 40.5149 16.2022 38.628 16.9854C36.7411 17.7686 34.6411 17.8732 32.6857 17.2816C30.7303 16.6899 29.0405 15.4385 27.9044 13.7406C26.7683 12.0427 26.256 10.0033 26.455 7.97007C26.6539 5.93682 27.5518 4.03547 28.9955 2.59C29.8134 1.76806 30.7858 1.11605 31.8567 0.671542C32.9277 0.227033 34.076 -0.00119525 35.2355 4.70729e-06Z"/></svg>';function $(e){const t=document.createElement("button");return t.type="button",t.className="a11y-trigger",t.setAttribute("aria-haspopup","true"),t.setAttribute("aria-expanded","false"),t.setAttribute("aria-label",r.triggerLabel),t.innerHTML=C,t.addEventListener("click",e),t}const O='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><path d="M18 6 6 18M6 6l12 12"/></svg>',P='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 1 0 3-6.7L3 8"/><path d="M3 3v5h5"/></svg>',M=[{lvl:0,label:"A",size:"13px"},{lvl:1,label:"A+",size:"16px"},{lvl:2,label:"A++",size:"20px"}],_=[{key:"highContrast",label:r.highContrast,icon:"◑"},{key:"grayscale",label:r.grayscale,icon:"◐"},{key:"highlightLinks",label:r.highlightLinks,icon:"🔗"},{key:"bigCursor",label:r.bigCursor,icon:"↖"}];class R{constructor(t,a){this.store=t,this.trigger=a,this.open=!1,this.lastFocus=null,this.onClick=o=>{const i=o.target.closest("[data-act]");if(!i)return;const n=this.store.get();switch(i.dataset.act){case"close":this.close();break;case"font":this.store.update({fontSize:Number(i.dataset.lvl)});break;case"toggle":{const l=i.dataset.key,d=!n[l];this.store.update({[l]:d}),this.announce(d?r.on:r.off);break}case"reset":this.store.reset(),this.announce(r.resetDone);break}},this.onKeydown=o=>{if(o.key==="Escape"){this.close();return}if(o.key!=="Tab")return;const i=this.focusable();if(!i.length)return;const n=i[0],l=i[i.length-1];o.shiftKey&&document.activeElement===n?(o.preventDefault(),l.focus()):!o.shiftKey&&document.activeElement===l&&(o.preventDefault(),n.focus())},this.el=document.createElement("div"),this.el.className="a11y-panel",this.el.setAttribute("role","dialog"),this.el.setAttribute("aria-modal","true"),this.el.setAttribute("aria-label",r.panelTitle),this.el.setAttribute("data-open","false"),this.el.innerHTML=this.render(),this.live=this.el.querySelector(".a11y-live"),this.el.addEventListener("click",this.onClick),this.el.addEventListener("keydown",this.onKeydown),this.store.subscribe(o=>this.sync(o)),this.sync(this.store.get())}render(){const t=M.map(o=>`<button type="button" class="a11y-font-btn" data-act="font" data-lvl="${o.lvl}" style="font-size:${o.size}" aria-pressed="false">${o.label}</button>`).join(""),a=_.map(o=>`
      ...
      <div class="a11y-header">
        <span class="a11y-header-title">${C}<span>${r.panelTitle}</span></span>
        <button type="button" class="a11y-close" data-act="close" aria-label="${r.close}">${O}</button>
      </div>
      <div class="a11y-body">
        <div>
          <p class="a11y-section-label">${r.fontSizeGroup}</p>
          <div class="a11y-font-row">${t}</div>
        </div>
        ${a}
        <button type="button" class="a11y-reset" data-act="reset">${P}<span>${r.reset}</span></button>
        <div class="a11y-statement" hidden></div>
        <div class="a11y-sr-only a11y-live" role="status" aria-live="polite"></div>
      </div>
    `}setStatement(t){const a=this.el.querySelector(".a11y-statement");if(!a)return;const o=t&&(t.url||t.coordinatorName||t.coordinatorPhone||t.coordinatorEmail);if(!t||!o){a.hidden=!0,a.innerHTML="";return}const i=[`<p class="a11y-section-label">${r.statementTitle}</p>`],n=U(t.url);n&&i.push(`<a href="${u(n)}" target="_blank" rel="noopener noreferrer">${r.statementLink}</a>`),(t.coordinatorName||t.coordinatorPhone||t.coordinatorEmail)&&(i.push('<div class="a11y-coordinator">'),t.coordinatorName&&i.push(`<div class="a11y-coord-name">${r.coordinator}: ${h(t.coordinatorName)}</div>`),t.coordinatorPhone&&i.push(`<a href="tel:${u(t.coordinatorPhone.replace(/[^\d+]/g,""))}">☎ ${h(t.coordinatorPhone)}</a>`),t.coordinatorEmail&&i.push(`<a href="mailto:${u(t.coordinatorEmail)}">✉ ${h(t.coordinatorEmail)}</a>`),i.push("</div>")),a.innerHTML=i.join(""),a.hidden=!1}focusable(){return Array.from(this.el.querySelectorAll("button")).filter(t=>t.offsetParent!==null)}sync(t){this.el.querySelectorAll("[data-act='font']").forEach(a=>{a.setAttribute("aria-pressed",String(Number(a.dataset.lvl)===t.fontSize))}),this.el.querySelectorAll("[data-act='toggle']").forEach(a=>{a.setAttribute("aria-pressed",String(!!t[a.dataset.key]))})}announce(t){this.live.textContent="",window.requestAnimationFrame(()=>this.live.textContent=t)}toggle(){this.open?this.close():this.show()}show(){var t;this.open=!0,this.lastFocus=document.activeElement,this.el.setAttribute("data-open","true"),this.trigger.setAttribute("aria-expanded","true"),(t=this.focusable()[0])==null||t.focus()}close(){var t,a;this.open=!1,this.el.setAttribute("data-open","false"),this.trigger.setAttribute("aria-expanded","false"),(a=(t=this.lastFocus)==null?void 0:t.focus)==null||a.call(t)}}function h(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function u(e){return h(e).replace(/"/g,"&quot;")}function U(e){return e&&/^https?:\/\//i.test(e.trim())?e.trim():null}const k="__a11yWidgetLoaded",f=document.currentScript;function S(){const e=window;if(e[k])return;e[k]=!0;const t=new L,a=document.createElement("style");a.id="a11y-widget-styles",a.textContent=N(),document.head.appendChild(a),m(t.get()),t.subscribe(m);const o=document.createElement("div");o.id="a11y-widget-root";const i=$(()=>n.toggle()),n=new R(t,i);o.append(i,n.el),document.body.appendChild(o);const l=A(f);w(l),v(o,I(f));const d=T(f);z(d,l).then(s=>{s&&(w(s.protection),v(o,s.appearance),n.setStatement(s.statement))}),e.A11yWidget={open:()=>n.show(),close:()=>n.close(),reset:()=>t.reset(),setStatement:s=>n.setStatement(s)}}document.body?S():document.addEventListener("DOMContentLoaded",S,{once:!0})})();
