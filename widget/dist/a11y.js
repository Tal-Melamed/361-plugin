(function(){"use strict";const l={fontSize:0,highContrast:!1,grayscale:!1,highlightLinks:!1,bigCursor:!1},c="bugbox_a11y",d=["100%","120%","145%"];class b{constructor(){this.listeners=new Set,this.state=this.load()}load(){try{const t=localStorage.getItem(c);return t?{...l,...JSON.parse(t)}:{...l}}catch(t){return{...l}}}persist(){try{localStorage.setItem(c,JSON.stringify(this.state))}catch(t){}}get(){return this.state}update(t){this.state={...this.state,...t},this.persist(),this.emit()}reset(){this.state={...l};try{localStorage.removeItem(c)}catch(t){}this.emit()}subscribe(t){return this.listeners.add(t),()=>this.listeners.delete(t)}emit(){for(const t of this.listeners)t(this.state)}}function y(a){var o;const t=(o=a==null?void 0:a.dataset)!=null?o:{};return{protectMedia:t.protectMedia!=="0",disableTextSelection:t.noTextSelect==="1",removeTapHighlight:t.tapHighlight!=="0",disableLinkLongPress:t.noLinkPreview!=="0"}}function p(a){var o;const t=document.documentElement;t.style.setProperty("--a11y-font-scale",(o=d[a.fontSize])!=null?o:d[0]),t.classList.toggle("a11y-high-contrast",a.highContrast),t.classList.toggle("a11y-grayscale",a.grayscale),t.classList.toggle("a11y-highlight-links",a.highlightLinks),t.classList.toggle("a11y-big-cursor",a.bigCursor)}function x(a){const t=document.documentElement;if(t.classList.toggle("a11y-protect-media",a.protectMedia),t.classList.toggle("a11y-no-select",a.disableTextSelection),t.classList.toggle("a11y-no-tap-highlight",a.removeTapHighlight),t.classList.toggle("a11y-no-link-preview",a.disableLinkLongPress),a.protectMedia){const o=e=>e instanceof Element&&/^(IMG|VIDEO|PICTURE|SOURCE)$/.test(e.tagName)&&!e.closest("#a11y-widget-root");document.addEventListener("dragstart",e=>{o(e.target)&&e.preventDefault()}),document.addEventListener("contextmenu",e=>{o(e.target)&&e.preventDefault()},{capture:!0})}}function m(){return`
...
`}const i={triggerLabel:"פתח תפריט נגישות",panelTitle:"נגישות",close:"סגירה",reset:"איפוס הגדרות",fontSizeGroup:"גודל גופן",highContrast:"ניגודיות גבוהה",grayscale:"גווני אפור",highlightLinks:"הדגשת קישורים",bigCursor:"סמן גדול",on:"מופעל",off:"כבוי",resetDone:"כל ההגדרות אופסו"},h='<svg viewBox="0 0 71 82" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M34.8455 53.52L25.8955 78.25C25.6755 78.8697 25.3339 79.4392 24.8909 79.9252C24.4479 80.4111 23.9123 80.8038 23.3155 81.08C22.4191 81.5003 21.4181 81.645 20.4393 81.4958C19.4606 81.3466 18.5482 80.9101 17.8178 80.2418C17.0873 79.5735 16.5717 78.7033 16.3363 77.7417C16.1009 76.78 16.1563 75.7701 16.4955 74.84L22.7355 57.56C23.2307 56.2597 23.6219 54.9222 23.9055 53.56C24.1577 52.1769 24.3379 50.7817 24.4455 49.38C24.6855 46.85 24.8555 44.11 24.9855 41.48C25.1155 38.85 25.2055 36.3 25.2755 34.19C25.3655 31.56 24.6555 31.39 22.5455 30.89L22.1055 30.79L4.10551 27.4C3.45813 27.2858 2.83963 27.0451 2.28539 26.6916C1.73114 26.3381 1.25205 25.8788 0.875506 25.34C0.316124 24.5237 0.0115401 23.5598 0.000321458 22.5703C-0.0108972 21.5808 0.271754 20.6102 0.812486 19.7814C1.35322 18.9527 2.12771 18.303 3.0379 17.9147C3.94809 17.5263 4.95304 17.4168 5.92551 17.6L25.2655 21.23C26.0355 21.3 26.7855 21.39 27.5755 21.48C29.9555 21.8061 32.3535 21.9831 34.7555 22.01C37.7456 21.9516 40.7301 21.7279 43.6955 21.34C44.5955 21.24 45.4455 21.13 46.2955 21.05L64.5455 17.63C65.8402 17.3615 67.1886 17.6168 68.2955 18.34C68.8441 18.7112 69.3135 19.1878 69.6764 19.7419C70.0393 20.2961 70.2885 20.9169 70.4094 21.5681C70.5304 22.2194 70.5207 22.8882 70.381 23.5357C70.2413 24.1833 69.9743 24.7966 69.5955 25.34C69.2241 25.8823 68.7494 26.346 68.1986 26.7046C67.6478 27.0632 67.0317 27.3097 66.3855 27.43L48.9455 30.71C48.3655 30.84 47.8455 30.93 47.3855 31C45.5655 31.31 44.6655 31.47 44.7755 34.06C44.8555 35.95 45.0855 38.21 45.3855 40.57C45.7355 43.34 46.1955 46.28 46.6755 48.97C46.9855 50.74 47.2755 52.16 47.6755 53.52C48.0755 54.88 48.4655 56.27 49.0655 57.94L55.1755 74.84C55.5147 75.7701 55.5701 76.78 55.3347 77.7417C55.0993 78.7033 54.5837 79.5735 53.8532 80.2418C53.1228 80.9101 52.2104 81.3466 51.2317 81.4958C50.2529 81.645 49.2519 81.5003 48.3555 81.08C47.7587 80.8038 47.2231 80.4111 46.7801 79.9252C46.3371 79.4392 45.9955 78.8697 45.7755 78.25L36.7955 53.57L35.7955 51.74L34.7955 53.52H34.8455ZM35.2355 4.70729e-06C37.2785 -0.00173208 39.2588 0.704987 40.8391 1.99973C42.4194 3.29448 43.5018 5.09714 43.902 7.10053C44.3021 9.10392 43.9952 11.1841 43.0335 12.9865C42.0718 14.789 40.5149 16.2022 38.628 16.9854C36.7411 17.7686 34.6411 17.8732 32.6857 17.2816C30.7303 16.6899 29.0405 15.4385 27.9044 13.7406C26.7683 12.0427 26.256 10.0033 26.455 7.97007C26.6539 5.93682 27.5518 4.03547 28.9955 2.59C29.8134 1.76806 30.7858 1.11605 31.8567 0.671542C32.9277 0.227033 34.076 -0.00119525 35.2355 4.70729e-06Z"/></svg>';function w(a){const t=document.createElement("button");return t.type="button",t.className="a11y-trigger",t.setAttribute("aria-haspopup","true"),t.setAttribute("aria-expanded","false"),t.setAttribute("aria-label",i.triggerLabel),t.innerHTML=h,t.addEventListener("click",a),t}const v='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><path d="M18 6 6 18M6 6l12 12"/></svg>',C='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12a9 9 0 1 0 3-6.7L3 8"/><path d="M3 3v5h5"/></svg>',k=[{lvl:0,label:"A",size:"13px"},{lvl:1,label:"A+",size:"16px"},{lvl:2,label:"A++",size:"20px"}],L=[{key:"highContrast",label:i.highContrast,icon:"◑"},{key:"grayscale",label:i.grayscale,icon:"◐"},{key:"highlightLinks",label:i.highlightLinks,icon:"🔗"},{key:"bigCursor",label:i.bigCursor,icon:"↖"}];class S{constructor(t,o){this.store=t,this.trigger=o,this.open=!1,this.lastFocus=null,this.onClick=e=>{const s=e.target.closest("[data-act]");if(!s)return;const r=this.store.get();switch(s.dataset.act){case"close":this.close();break;case"font":this.store.update({fontSize:Number(s.dataset.lvl)});break;case"toggle":{const n=s.dataset.key,f=!r[n];this.store.update({[n]:f}),this.announce(f?i.on:i.off);break}case"reset":this.store.reset(),this.announce(i.resetDone);break}},this.onKeydown=e=>{if(e.key==="Escape"){this.close();return}if(e.key!=="Tab")return;const s=this.focusable();if(!s.length)return;const r=s[0],n=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),n.focus()):!e.shiftKey&&document.activeElement===n&&(e.preventDefault(),r.focus())},this.el=document.createElement("div"),this.el.className="a11y-panel",this.el.setAttribute("role","dialog"),this.el.setAttribute("aria-modal","true"),this.el.setAttribute("aria-label",i.panelTitle),this.el.setAttribute("data-open","false"),this.el.innerHTML=this.render(),this.live=this.el.querySelector(".a11y-live"),this.el.addEventListener("click",this.onClick),this.el.addEventListener("keydown",this.onKeydown),this.store.subscribe(e=>this.sync(e)),this.sync(this.store.get())}render(){const t=k.map(e=>`<button type="button" class="a11y-font-btn" data-act="font" data-lvl="${e.lvl}" style="font-size:${e.size}" aria-pressed="false">${e.label}</button>`).join(""),o=L.map(e=>`
      ...
      <div class="a11y-header">
        <span class="a11y-header-title">${h}<span>${i.panelTitle}</span></span>
        <button type="button" class="a11y-close" data-act="close" aria-label="${i.close}">${v}</button>
      </div>
      <div class="a11y-body">
        <div>
        ...
        ${o}
        <button type="button" class="a11y-reset" data-act="reset">${C}<span>${i.reset}</span></button>
        <div class="a11y-sr-only a11y-live" role="status" aria-live="polite"></div>
      </div>
    `}focusable(){return Array.from(this.el.querySelectorAll("button")).filter(t=>t.offsetParent!==null)}sync(t){this.el.querySelectorAll("[data-act='font']").forEach(o=>{o.setAttribute("aria-pressed",String(Number(o.dataset.lvl)===t.fontSize))}),this.el.querySelectorAll("[data-act='toggle']").forEach(o=>{o.setAttribute("aria-pressed",String(!!t[o.dataset.key]))})}announce(t){this.live.textContent="",window.requestAnimationFrame(()=>this.live.textContent=t)}toggle(){this.open?this.close():this.show()}show(){var t;this.open=!0,this.lastFocus=document.activeElement,this.el.setAttribute("data-open","true"),this.trigger.setAttribute("aria-expanded","true"),(t=this.focusable()[0])==null||t.focus()}close(){var t,o;this.open=!1,this.el.setAttribute("data-open","false"),this.trigger.setAttribute("aria-expanded","false"),(o=(t=this.lastFocus)==null?void 0:t.focus)==null||o.call(t)}}const g="__a11yWidgetLoaded",E=document.currentScript;function u(){const a=window;if(a[g])return;a[g]=!0;const t=new b,o=document.createElement("style");o.id="a11y-widget-styles",o.textContent=m(),document.head.appendChild(o),p(t.get()),t.subscribe(p),x(y(E));const e=document.createElement("div");e.id="a11y-widget-root";const s=w(()=>r.toggle()),r=new S(t,s);e.append(s,r.el),document.body.appendChild(e),a.A11yWidget={open:()=>r.show(),close:()=>r.close(),reset:()=>t.reset()}}document.body?u():document.addEventListener("DOMContentLoaded",u,{once:!0})})();
