(function(){"use strict";const d={fontSize:0,highContrast:!1,grayscale:!1,highlightLinks:!1,bigCursor:!1},p="bugbox_a11y",h=["100%","120%","145%"];class v{constructor(){this.listeners=new Set,this.state=this.load()}load(){try{const t=localStorage.getItem(p);return t?{...d,...JSON.parse(t)}:{...d}}catch(t){return{...d}}}persist(){try{localStorage.setItem(p,JSON.stringify(this.state))}catch(t){}}get(){return this.state}update(t){this.state={...this.state,...t},this.persist(),this.emit()}reset(){this.state={...d};try{localStorage.removeItem(p)}catch(t){}this.emit()}subscribe(t){return this.listeners.add(t),()=>this.listeners.delete(t)}emit(){for(const t of this.listeners)t(this.state)}}const k="https://nblbeaawytyuxgfoixlj.supabase.co",g="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5ibGJlYWF3eXR5dXhnZm9peGxqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODM0NDQ1NTcsImV4cCI6MjA5OTAyMDU1N30.ZHVeYpEBf2tUpS1iz30YXjVierROAgqrHJG5zHSmyJo";function S(o){var a;const t=(a=o==null?void 0:o.dataset)!=null?a:{};return{protectMedia:t.protectMedia!=="0",disableTextSelection:t.noTextSelect==="1",removeTapHighlight:t.tapHighlight!=="0",disableLinkLongPress:t.noLinkPreview!=="0"}}function L(o){var t;return(t=o==null?void 0:o.dataset.siteKey)!=null?t:""}async function E(o,t){if(!o)return null;try{const a=await fetch(`${k}/rest/v1/rpc/get_widget_config`,{method:"POST",headers:{apikey:g,authorization:`Bearer ${g}`,"content-type":"application/json"},body:JSON.stringify({p_site_key:o})});if(!a.ok)return null;const e=await a.json();return!e||!e.protection?null:{...t,...e.protection}}catch(a){return null}}function u(o){var a;const t=document.documentElement;t.style.setProperty("--a11y-font-scale",(a=h[o.fontSize])!=null?a:h[0]),t.classList.toggle("a11y-high-contrast",o.highContrast),t.classList.toggle("a11y-grayscale",o.grayscale),t.classList.toggle("a11y-highlight-links",o.highlightLinks),t.classList.toggle("a11y-big-cursor",o.bigCursor)}let l=null,f=!1;function b(o){l=o;const t=document.documentElement;if(t.classList.toggle("a11y-protect-media",o.protectMedia),t.classList.toggle("a11y-no-select",o.disableTextSelection),t.classList.toggle("a11y-no-tap-highlight",o.removeTapHighlight),t.classList.toggle("a11y-no-link-preview",o.disableLinkLongPress),!f){f=!0;const a=e=>e instanceof Element&&/^(IMG|VIDEO|PICTURE|SOURCE)$/.test(e.tagName)&&!e.closest("#a11y-widget-root");document.addEventListener("dragstart",e=>{l!=null&&l.protectMedia&&a(e.target)&&e.preventDefault()}),document.addEventListener("contextmenu",e=>{l!=null&&l.protectMedia&&a(e.target)&&e.preventDefault()},{capture:!0})}}function A(){return`
